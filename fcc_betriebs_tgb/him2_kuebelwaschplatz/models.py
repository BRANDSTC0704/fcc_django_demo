...
from him2_referenzdaten.models import KuebelArt, Mitarbeiter, BetankungSession
...
class KuebelSession(models.Model):
    ...
    )  # e.g. session name or user-provided
...
class KuebelEintrag(models.Model):
    ...
    log = models.ForeignKey(
        KuebelSession, related_name="kuebel", on_delete=models.CASCADE
    )
